...
class Field_blurb
{
	...
	public $custom_parameters		= array('amount', 'folder_choice');
	public $author             = array('name'=>'James Doyle', 'url'=>'http://github.com/james2doyle/pyro-blurb-field');
	...
	public function form_output($data)
	{
		...
		$folderid = $data['custom']['folder_choice'];
...
$template = '<div id="amount_field_input"><div id="amount_value">'.$value.'</div><a href="#" class="button" id="amount_up">+</a>&nbsp;<a href="#" class="button" id="amount_down">-</a></div>'.$styles.$scripts;
